// Generated from c:/Users/gabri/ssl-antlr-calculator/Calculator.g4 by ANTLR 4.13.2
// jshint ignore: start
...
export default class CalculatorParser extends antlr4.Parser {
	...
	stat() {
	    ...
	    try {
	        ...
	        switch(la_) {
	        case 1:
	            localctx = new DeclarationStatContext(this, localctx);
	            this.enterOuterAlt(localctx, 1);
	            this.state = 15;
	            this.decl();
	            break;
	        ...
	        case 2:
	            localctx = new AssignmentStatContext(this, localctx);
	        ...
	        case 3:
	            localctx = new ExpressionStatContext(this, localctx);
...
class ExpressionStatContext extends StatContext {
...
CalculatorParser.ExpressionStatContext = ExpressionStatContext;

class AssignmentStatContext extends StatContext {
...
CalculatorParser.AssignmentStatContext = AssignmentStatContext;

class DeclarationStatContext extends StatContext {
	...
	enterRule(listener) {
	    if(listener instanceof CalculatorListener ) {
	        listener.enterDeclarationStat(this);
		}
	}

	exitRule(listener) {
	    if(listener instanceof CalculatorListener ) {
	        listener.exitDeclarationStat(this);
		}
	}

	accept(visitor) {
	    if ( visitor instanceof CalculatorVisitor ) {
	        return visitor.visitDeclarationStat(this);
	    } else {
	        return visitor.visitChildren(this);
	    }
	}
...
CalculatorParser.DeclarationStatContext = DeclarationStatContext;
...
class DeclarationContext extends DeclContext {
...
class AssignmentContext extends AssignContext {
...
CalculatorParser.NumberExprContext = NumberExprContext;
...
CalculatorParser.MulDivExprContext = MulDivExprContext;
...
CalculatorParser.IdExprContext = IdExprContext;
